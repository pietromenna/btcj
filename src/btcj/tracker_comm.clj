...
(defn prepare-map-for-request [torrent-file-contents]
  (let [info_hash (sha1-to-form-encoded (sha-1 (bencode-dict (torrent-file-contents info))))
        peer_id "ABCDEFGHIJK123456789"
        port 19999
        uploaded 0
        downloaded 0
        compact 0]
    (hash-map :info_hash info_hash :peer_id peer_id :port port :uploaded uploaded :downloaded downloaded :compact compact)))
